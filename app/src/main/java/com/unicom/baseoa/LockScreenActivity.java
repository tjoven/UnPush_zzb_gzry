...
public class LockScreenActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		init();	
		loadurl(webView,"file:///android_asset/wap/im/setting/passwordInput.html"); 
...
/*					if(url.indexOf("login.html")>0){
				...
				public void onReceivedError(WebView view, int errorCode,
					...
					webView.loadUrl(temp[0]);
						...
						//urlpara="";
					Toast.makeText(LockScreenActivity.this, "网络连接出错！", Toast.LENGTH_LONG).show();
					}
				}	
...
//			File file = CacheManager.getCacheFileBaseDir();
			...
			LockScreenActivity.this.deleteDatabase("webview.db");
			LockScreenActivity.this.deleteDatabase("webviewCache.db");
		   this.finish();
		   return true;
		   
		}else if(item.getItemId()==2){
			Intent intent=new Intent();
			intent.setClass(LockScreenActivity.this, Settings.class);
			startActivity(intent);
...
*/		
	...
	public void closeWin(String data){//返回WebViewWnd
        Intent intent = new Intent();  
		intent.setClass(LockScreenActivity.this, WebViewWnd.class);
...
/*        Intent intent = new Intent();     
	...
	public void asyncHttpRequest(String url,String data,final String sys_timeStamp,final String callback){
		String str = LockScreenActivity.this.getString(R.string.SETTING_INFOS);
		SharedPreferences settings = LockScreenActivity.this.getSharedPreferences(str, 0);
		...
		client.post(url, params, new AsyncHttpResponseHandler() {
		    ...
		    public void onSuccess(String response) {
		    	if(!"".equals(callback)){
		    		LockScreenActivity.this.webView.loadUrl("javascript:"+callback+"("+response+",'"+sys_timeStamp+"')");
		    	}
